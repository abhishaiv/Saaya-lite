...
export const SHADOW_SAMPLING_SEC = 15;
export const SOS_SAMPLING_SEC = 5;
export const PENDING_DWELL_SAMPLING_SEC = 15;
export const MAX_CONTAINMENT_ACCURACY_M = 100;
export const MIN_ENTRY_FIXES = 5;
