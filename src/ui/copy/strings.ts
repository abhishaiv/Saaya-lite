...
export type M4Copy = Readonly<{
  ...
  demoSetupTitle: string;
  demoSetupBody: string;
  demoSetupStorageError: string;
  demoSetupWrongPin: string;
...
export const M4_COPY: Readonly<Record<SaayaLocale, M4Copy>> = {
  en: {
    ...
    aboutRealFamily: "First-miss WhatsApp request (private demo setup and receipt verification required)",
    ...
    aboutPrivacyBoundary: "In a configured demo, the first missed check-in requests a test alert through WhatsApp. The provider receives the configured recipient's number and the test text. Saaya cannot confirm receipt. Without private setup, no alert is sent. The police preview is synthetic and stays on this phone.",
    aboutTitle: "About",
    ...
    alertCancelNote: "I'm OK resets the check-ins. A request already submitted cannot be recalled.",
    ...
    demoStartDisclosure: "This is a simulated journey. After the first missed check-in, Saaya requests a real WhatsApp test alert if private messaging setup is ready. The provider receives the configured recipient and message. Receipt is not guaranteed. I'm OK resets the countdown, but cannot recall a submitted message. SOS stops only with your demo PIN.",
    demoSetupTitle: "Set your demo PIN",
    demoSetupWrongPin: "That PIN does not match. Try again.",
    demoSetupBody: "Choose a four-digit PIN to stop the simulated SOS. This PIN stays on this phone, is only for the demo, and does not replace your usual PIN. No location or favourite is needed.",
    demoSetupStorageError: "This browser could not save the demo PIN. Please allow site storage and try again.",
    demoTimingNote: "Demo accelerated · %1$ds per check-in · %2$ds between prompts",
...
Prepared locally by Saaya Lite.`,
    familyMockDisclosure: "Demo WhatsApp needs private setup and an opted-in test recipient. Saaya can report provider acceptance, not family receipt. Normal SUS does not send to the demo recipient. No police system is connected.",
  ...
  te: {
    ...
    aboutRealFamily: "మొదటి చెక్-ఇన్ మిస్ అయినప్పుడు WhatsApp అభ్యర్థన (ప్రైవేట్ డెమో సెటప్, అందుకున్నట్టు ధృవీకరణ అవసరం)",
    ...
    aboutPrivacyBoundary: "సెటప్ చేసిన డెమోలో మొదటి చెక్-ఇన్ మిస్ అయితే WhatsApp ద్వారా పరీక్ష సందేశం పంపమని అభ్యర్థిస్తుంది. ప్రొవైడర్‌కు ఎంచుకున్న వ్యక్తి నంబర్, పరీక్ష సందేశం అందుతాయి. సందేశం అందిందని సాయ నిర్ధారించలేదు. ప్రైవేట్ సెటప్ లేకుండా సందేశం పంపదు. పోలీస్ ప్రివ్యూ కల్పితం; ఈ ఫోన్‌లోనే ఉంటుంది.",
    aboutTitle: "గురించి",
    ...
    alertCancelNote: "\"నేను బాగున్నాను\" చెక్-ఇన్‌లను మళ్లీ మొదలుపెడుతుంది. ఇప్పటికే సమర్పించిన అభ్యర్థనను వెనక్కి తీసుకోలేము.",
    ...
    demoStartDisclosure: "ఇది అనుకరించిన ప్రయాణం. మొదటి చెక్-ఇన్ మిస్ అయితే, ప్రైవేట్ సెటప్ సిద్ధంగా ఉన్నప్పుడు సాయ WhatsApp పరీక్ష సందేశాన్ని అభ్యర్థిస్తుంది. సేవాదారుకు ఎంచుకున్న గ్రహీత నంబరు, సందేశం అందుతాయి. సందేశం అందుతుందని హామీ లేదు. ‘నేను బాగున్నాను’ కౌంట్‌డౌన్‌ను రీసెట్ చేస్తుంది, కానీ పంపడానికి సమర్పించిన సందేశాన్ని వెనక్కి తీసుకోలేదు. SOS మీ డెమో PIN తోనే ఆగుతుంది.",
    demoSetupTitle: "మీ డెమో PIN సెట్ చేయండి",
    demoSetupWrongPin: "ఆ PIN సరిపోలలేదు. మళ్లీ ప్రయత్నించండి.",
    demoSetupBody: "అనుకరించిన SOS ఆపడానికి నాలుగు అంకెల PIN ఎంచుకోండి. ఇది ఈ ఫోన్‌లోనే ఉంటుంది, డెమోకు మాత్రమే వర్తిస్తుంది, మీ సాధారణ PIN మార్చదు. లొకేషన్ లేదా ఆత్మీయుల వివరాలు అవసరం లేదు.",
    demoSetupStorageError: "ఈ బ్రౌజర్ డెమో PIN సేవ్ చేయలేకపోయింది. సైట్ నిల్వను అనుమతించి మళ్లీ ప్రయత్నించండి.",
    demoTimingNote: "వేగవంతమైన డెమో · ప్రతి చెక్-ఇన్‌కు %1$d సెకన్లు · మధ్యలో %2$d సెకన్ల విరామం",
...
సాయ లైట్ ఈ సందేశాన్ని ఈ ఫోన్‌లోనే తయారుచేసింది.`,
    familyMockDisclosure: "డెమో WhatsApp కు ప్రైవేట్ సెటప్, సమ్మతించిన పరీక్ష గ్రహీత అవసరం. సేవాదారు అంగీకరించినట్టు సాయ చూపగలదు; ఆత్మీయులకు అందినట్టు కాదు. సాధారణ SUS డెమో గ్రహీతకు పంపదు. ఏ పోలీస్ వ్యవస్థతోనూ అనుసంధానం లేదు.",
