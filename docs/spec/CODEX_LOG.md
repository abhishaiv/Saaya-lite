...
M1 step 4 (2026-08-28): SOS and the local PIN gate are committed; state-delivery and queue text intentionally wait for M2’s real writer instead of making a false delivery claim.
