...
| Camera distance behind her | `walk.camera.dist` 13.0 m | 10.98 m of ground back, 6.97 m up |
| Where the axis crosses her vertical | `walk.camera.look_at` 3.21 m | 1.89x her height |
| Horizon, as a fraction of frame height | 0.1643 | 0.164 |
| Her feet, and her head | 0.7358 / 0.6158 | 0.736 / 0.616 |
| Her height on screen | 0.120 | 0.120 |
...
changes these rates by well under a percentage point - not re-measured, and not relied on.
...
distance the frame shows about 6 m of ground across - 6.05 m at the row of her feet, solved
from `walk.camera.fov` 54 on a 390x844 viewport - so a single road was four frames' worth of
width and the picture was that road. A rendering width, carrying no claim, and no product claim
depends on how wide a street is drawn.
