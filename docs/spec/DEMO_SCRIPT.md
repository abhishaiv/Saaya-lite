...
| 1:38 - 1:58 | Family escalation preview, red, the exact message, the disclosure banner in frame | "Saaya prepares the area, the hour, that area's record, and the two missed checks. Not a blank alarm. The prototype label is on screen: we compose this message locally, we do not send it, because real delivery needs Indian DLT registration." |
