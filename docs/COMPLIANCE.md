...
|---|---|
| SMS or WhatsApp to her favourites | User-controlled device handoff only: Saaya prepares the message locally; her tap attempts to open her own app for review and sending. Saaya never dispatches it, observes delivery or uploads contact data. |
